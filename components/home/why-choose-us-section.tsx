    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-blue-800 mb-4">Why Choose GATE College?</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Discover what makes GATE College the perfect place to pursue your educational goals and build your future.
          </p>
        </motion.div>
